$(document).ready(function() {
    ...
    // time duration of 15 seconds for each question
    var time = 15;
    // this will keep tally of right guesses to display at the end of the game
    var correctGuesses = 0;
    // this will keep tally of wrong guesses to display at the end game
    ...
    var questions = [
	  ...
	  {
	    question: "What anime series is Picachu from?",
	...
	function resultsScreen() {
		if (correctGuesses === questions.length) {
			...
			var bottomText = "#Champion";
		}
		else if (correctGuesses > incorrectGuesses) {
			var endMessage = "Good work! Try again to beat your best score!";
			var bottomText = "Winner Winner Chicken Dinner!";
		}
		else {
			var endMessage = "You lose!";
			var bottomText = "Try again!";
		}
